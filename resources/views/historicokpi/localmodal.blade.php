          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> {{$kpi->nombre}} por día: {{$formato}}, local {{$local}}</h3>
              </div>
              ...
              <div class="card-header border-0">
                ...
                <div class="card-tools">
                  ...
                  <form action="{{ route('historicokpis.modal', [ 'kpiid'=>$kpi->id , 'formato'=>$formato , 'local' => $local  ]) }}" method="GET" class="navbar-form navbar-left" id="myform" name="myform">
                    <a class="btn btn-secondary btn-sm"  role="button" id="exportpdf" title="Reporte PDF"> 
                      <i class="far fa-file-pdf"></i>
                      
                    </a>
                    <a class="btn btn-secondary btn-sm" href="{{ route('exportExcelHistorico', [ 'kpiid'=>$kpi->id , 'formato'=>$formato , 'local' => $local, 'archivoExcel' => $kpi->nombre. ' por dia '. $formato .' '. $local .' ' . date('d-m-Y')  ]) }}" role="button" title="Exportar Excel">
                    ...
                    <input id="endDate" name="endDate" type="hidden" >
                     ...
                     <a type="submit" class="btn btn-secondary btn-sm" role="button" id="daterange-btn" title="Rango Días"> 
              ...
              @if ( $fechasD->first()   == null )
                ...
                <table id="example1xx" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>{{ date("d-m-Y", strtotime($locale->fecha)) }}</td>
                        
                        <td><span class=" bg-danger">{{ $locale->valor }} {{ $kpi->formato }}
                        </span>
...
Highcharts.exportCharts = function(charts, options) {
    ...
    Highcharts.post(options.url, {
      filename: options.filename || '{{$kpi->nombre}} por día',
      type: options.type,
      width: options.width,
